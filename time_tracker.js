...
const displayTimeTracker = () => {
    ...
    document.getElementById("TimetrackerBody").innerHTML = html
}
...
var btn = document.getElementById("timeStart")
var counter = document.getElementById("timeTracker")
var flag = 0;
...
addItemsTimeTracker = () => {
  if(flag === 1){
        let timeTrackerDesc = document.getElementById("TimetrackerDescription").value;
             ...
             location.reload();
                ...
                for( i in array){
                    ...
                    location.reload();
                        ...
                        array.push(store)
                        localStorage.setItem("local",JSON.stringify(array))
                        document.getElementById("TimetrackerDescription").value = "";
